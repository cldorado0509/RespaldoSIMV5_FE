...
{
    [Authorize]
    public class VertimientosController : Controller
    {
        ...
        public ActionResult PruebaJsonPost()
        {
            return View();
        }

        public string ProcesarJson()
        {

            string jsonInfo = Request.Params["jsonInfo"];

            return "Num Caracteres " + jsonInfo.Length;
        }
        ...
        public ActionResult ConsultarInformacionCaptacion()
        {
            ...
            dbcontrol.SP_GET_VERTIMIENTO(idCaptacion, CoorX, CoorY, jSONOUT);
        ...
        public ActionResult GuardarInformacionCaptacion()
        {
            if (((System.Security.Claims.ClaimsPrincipal)context.User).FindFirst(ClaimTypes.NameIdentifier) != null)
            {
                ...
                dbcontrol.SP_SET_VERTIMIENTO(jsonInfo, decUsuario, "MANUAL", rTA);
        ...
        public ActionResult GuardarInformacionCaptacionAndEstado()
        {
            if (((System.Security.Claims.ClaimsPrincipal)context.User).FindFirst(ClaimTypes.NameIdentifier) != null)
            {
                ...
                if (rTA.Value.Equals("Ok"))
                {
                    ...
                    dbcontrol.SP_CREATE_ESTADO_V(form, tercero, instalacion, idCap, tipoestado, idVisita, rTA2);
        ...
        public ActionResult GuardarInformacionDetalle()
        {
            ...
            {
                Utilidades.Log.EscribirRegistro(HostingEnvironment.MapPath("~/LogErrores/" + DateTime.Today.ToString("yyyyMMdd") + ".txt"), "Error (GuardarInformacionDetalle - Aguas/Vertimientos).\r\n" + Utilidades.LogErrores.ObtenerError(error));
                throw error;
            }
        }
