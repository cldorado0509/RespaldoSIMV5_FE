...
{
    [Authorize]
    public class AguasSuperficialesController : Controller
    {
        ...
        public ActionResult ConsultarInformacionCaptacion()
        {
            ...
            Decimal idCaptacion =  Convert.ToDecimal(Request.Params["idCaptacion"]);
            Decimal CoorX = Convert.ToDecimal(Request.Params["X"].Replace(".", ","));
            Decimal CoorY = Convert.ToDecimal(Request.Params["Y"].Replace(".", ","));
