...
function pageonload() {
    ...
    Dynamsoft.WebTwainEnv.ResourcesPath = '/SIM/Resources';
...
function initCustomScan() {
    ...
    ObjString += "<label id ='lblShowUI' for = 'ShowUI'><input type='checkbox' id='ShowUI' checked />Show UI&nbsp;</label>";
    ObjString += "<label for = 'ADF__'><input type='checkbox' id='ADF__' checked />AutoFeeder&nbsp;</label>";
    ObjString += "<label for = 'Duplex__'><input type='checkbox' id='Duplex__'/>Duplex</label></li>";
