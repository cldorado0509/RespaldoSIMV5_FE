...
{
    public partial class caracteristicaFuentes : DevExpress.XtraReports.UI.XtraReport
    {
        public caracteristicaFuentes()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Codestado > 0)
            {
                ...
                if (dataSource == null)
                {
                    SIM.Areas.ControlVigilancia.reporte.aguas.variablesSubreport reporte = (SIM.Areas.ControlVigilancia.reporte.aguas.variablesSubreport)(((XRSubreport)sender).ReportSource);
