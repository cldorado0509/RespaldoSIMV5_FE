...
{
    public partial class aguaSuterranea : DevExpress.XtraReports.UI.XtraReport
    {
        public aguaSuterranea()
        {
            InitializeComponent();
        }
        ...
        private void aguaSuterranea_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            xrpEncabezado.Image = Image.FromFile(System.Web.Hosting.HostingEnvironment.MapPath("~/Content/imagenes/cabezoteVisitas.png"));
            xrpUbicacion.Image = Image.FromFile(System.Web.Hosting.HostingEnvironment.MapPath("~/Content/imagenes/mapa/Captaciones_Subterraneas.png"));
        }
    }
}
