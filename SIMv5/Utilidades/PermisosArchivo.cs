...
namespace SIM.Utilidades
{
    class PermisosArchivo
    {
        ...
        /// <summary>
        /// Verifica si se tiene acceso al disco donde se gaurdaran los documentos
        /// </summary>
        /// <param name="_Ruta">Ruta donde se almacenan los documentos de las PQRSD para veificar</param>
        /// <returns></returns>
        public static bool VerificaAccesoDisco(string _Ruta)
        {
            bool isWriteAccess = false;
            try
            {
                AuthorizationRuleCollection collection = Directory.GetAccessControl(_Ruta).GetAccessRules(true, true, typeof(System.Security.Principal.NTAccount));
